...
export interface Plan {
  ...
  priceM: number
  /** Monthly price in USD when billed annually (lower than priceM). Total annual = priceY × 12. */
  priceY: number
  popular: boolean
  cta: string
  features: string[]
...
// Tier features mirror frontend/src/lib/plan.ts FEATURE_ACCESS exactly.
// Update both files together when copy changes.
export const plans: Plan[] = [
  {
    name: 'Free',
    desc: 'Discover the terminal',
    priceM: 0,
    priceY: 0,
    popular: false,
    cta: 'Get started',
    features: [
      ...
      'Ticker workspace',
      'Charts (basic)',
      'Screener (basic filters)',
      'Global indicators · limited',
      'News flow · limited',
      'Portfolio · basic',
  ...
  {
    name: 'Pro',
    desc: 'The professional baseline',
    priceM: 9.99,
    priceY: 9.99,
    popular: true,
    ...
    features: [
      'Everything in Free',
      'Charts (advanced) — multi-pane, custom indicators',
      'Screener (advanced filters + presets)',
      'Risk engine (VaR, drawdown, scenarios)',
      'COT report',
      'Scenario planner',
      'Macro intelligence',
      'Global indicators · full',
      'News flow · full archive',
      'Portfolio · full',
      'Desktop app',
      '100 watchlist symbols',
      '10 saved workspaces',
      '100 alerts',
    ],
  },
  {
    ...
    features: [
      'Everything in Pro',
      'Event probabilities (Polymarket signals)',
      'On-chain analytics (MVRV, Z-Score, wallet flows)',
